...
public class BiggerCraftingTables
{
	public static final int
			...
			GUI_ID_BIG_CREATING_TABLE = 2,
			GUI_ID_HUGE_CRAFTING_TABLE = 3,
			GUI_ID_AUTO_HUGE_CRAFTING_TABLE = 4,
			GUI_ID_HUGE_CREATING_TABLE = 5,
			GUI_ID_GIANT_CRAFTING_TABLE = 6,
			GUI_ID_AUTO_GIANT_CRAFTING_TABLE = 7,
			GUI_ID_GIANT_CREATING_TABLE = 8;
